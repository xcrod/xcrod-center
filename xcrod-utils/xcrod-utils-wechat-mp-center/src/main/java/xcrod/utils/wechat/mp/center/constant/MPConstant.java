...
public class MPConstant {
    ...
    static final String SHANG_HAI_DOMAIN = "sh.api.weixin.qq.com";
    static final String SHEN_ZHEN_DOMAIN = "sz.api.weixin.qq.com";
    static final String XIANG_GANG_DOMAIN = "hk.api.weixin.qq.com";
